...
Feature: Consumption Details
  ...
  Scenario Outline: User with mobile product can see data consumption details page
    ...
    Examples:
          ...
          | convergente | Mobile Line Dashboard | smoke    |     | QANOV-492650 |
          | mobile      | Account               | sanity   | ber | QANOV-492651 |

  @jira.<jira_id> @android @ios @jira.cv.Future @manual @mobile @o2es @smoke
  Scenario Outline: User with mobile product can see the calls consumption details page
    ...
    Examples:
          | plan        | page                  | jira_id      |
          | convergente | Mobile Line Dashboard | QANOV-492652 |
          | mobile      | Account               | QANOV-492653 |
  ...
  @jira.<jira_id> @<priority> @android @ios @jira.cv.Future @manual @mobile @o2es
  Scenario Outline: User with mobile product can see the sms consumption details page
    ...
    Examples:
          | plan        | page                  | priority   | jira_id      |
          | convergente | Mobile Line Dashboard | regression | QANOV-492655 |
          | mobile      | Account               | smoke      | QANOV-492656 |
  ...
  @jira.<jira_id> @android @ios @jira.cv.Future @manual @mobile @o2es @regression
  Scenario Outline: User with landline who hasn't consumed calls sees an informative message
    Given user has a "internet" plan
