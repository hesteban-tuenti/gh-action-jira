...
Feature: Invoice Module
  ...
  @jira.link.relates_to.NOV-165898 @mobile @o2uk @smoke @webapp
  ...
  @jira.link.parent_test_plan.QANOV-24947 @jira.link.relates_to.NOV-101232 @live @mobile @next @o2uk @sanity @webapp
  ...
  @jira.link.relates_to.NOV-100681 @mobile @o2uk @qa @regression @webapp
  ...
  @jira.link.relates_to.NOV-165898 @mobile @o2uk @qa @smoke @webapp
  ...
  @jira.link.parent_test_plan.QANOV-77438 @jira.link.relates_to.NOV-101232 @mobile @o2uk @sanity @webapp
  ...
  @jira.QANOV-6241 @android @automatic @ios @jira.cv.11.1 @jira.link.parent_test_plan.QANOV-24141
  @jira.link.relates_to.NOV-100881 @mobile @o2uk @qa @regression @webapp
  Scenario: A legacy user who did reach the payment due date without paying can see a specific tag in the Bills card
    internal_checkpoint="CERT0:
    - PAYM: aaa.b@c.om, in01808o_175099@o2.com, inl_may8842@o2.com(447521116559) --> invalid user, without bills
    - MBB: test30689357@stf.ref.o2.co.uk, acce88909351@stf.ref.o2.co.uk
    https://app.zeplin.io/project/5a2bcf19ab11dec6c2ba05b6/screen/5beae42c08d1323cf3fc0c78. Some further explanations
    ...
    Given user has a "legacy postpay" account type
      ...
      And user is in the "Account" page
      And waits until the "latest_invoice" element is visible
     Then the "latest_invoice.bill_status" textfield that contains the "Payment due on" text is displayed
