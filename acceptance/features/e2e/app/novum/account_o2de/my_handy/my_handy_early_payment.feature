...
Feature: My Handy early payment
  ...
  @jira.link.depends_on.QANOV-224617 @manual @mobile @o2de @smoke @ber
  Scenario: Postpay user who has a MyHandy product with a "Ongoing", "Early payment canceled" or "Overdue" contract can access to the "Early Payment" screen
    Given user has a "postpay" account type
     ...
     Then the "Early Payment" page is displayed
      ...
      And the "contract_number_label" textfield with "Contract number" text is displayed
  ...
  @jira.QANOV-224619 @android @ios @jira.cv.14.2 @jira.link.depends_on.QANOV-224618 @manual @mobile @o2de @smoke @ber
  ...
  @jira.QANOV-224620 @android @ios @jira.cv.14.2 @jira.link.depends_on.QANOV-224619 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-224630 @android @ios @jira.cv.14.2 @jira.link.depends_on.QANOV-224615 @manual @mobile @o2de @smoke @ber
