...
Feature: Change Tariff
  ...
  @jira.<jira_id> @<ber> @<priority> @android @ios @jira.cv.14.2 @jira.link.depends_on.QANOV-44688 @manual @mobile @o2de
  Scenario Outline: A postpay user who <has_hasnot> requested a cancellation for his/her mobile line tariff and has the earliest possible extension date in the <time> can change the tariff from the account dashboard
    ...
    Given user has a "postpay" account type
     ...
     When clicks on the "tariff_card.change_tariff_button" button
     Then the internal webview with "<header>" header is displayed
      And clicks on the "navigation_top_bar.close_button" button
      And the "Account" page is displayed

    Examples:
          | has_hasnot | time   | header | priority   | ber | jira_id     |
          | has not    | future | o2.de  | smoke      | ber | QANOV-44707 |
          | has not    | past   | TBD    | regression |     | QANOV-44710 |
          | has        | future | TBD    | regression |     | QANOV-44709 |
          | has        | past   | TBD    | regression |     | QANOV-44712 |

  @jira.<jira_id> @<priority> @android @ios @jira.cv.14.2 @jira.link.depends_on.<depends_on> @manual @mobile @o2de
  Scenario Outline: A postpay user who <has_hasnot> requested a cancellation for his/her mobile line tariff and has the earliest possible extension date in the <time> can change the tariff from the "My Tariff" screen
    ...
    Examples:
          ...
          | has not    | future | TBD    | smoke      | QANOV-203597 | QANOV-203624 |
          | has not    | past   | TBD    | regression | QANOV-44701  | QANOV-203625 |
          | has        | future | TBD    | regression | QANOV-44703  | QANOV-203628 |
          | has        | past   | TBD    | regression | QANOV-260058 | QANOV-203629 |

  @jira.QANOV-195755 @android @ios @jira.cv.Future @jira.link.detects.O2DE-3079 @manual @mobile @o2de @sanity
  ...
  @jira.QANOV-195756 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195755 @jira.link.detects.O2DE-3079
  ...
  @jira.QANOV-195757 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195755 @jira.link.depends_on.QANOV-195756
  @manual @mobile @o2de @smoke
  Scenario: A prepay user can select a tariff
    ...
    Given user has a "prepay" account type
     ...
     When clicks on the "select_tariff_button" button of any element of the "offered_tariffs_list" list
     Then the "Selected Tariff" page is displayed
      ...
      And the "tariff_price.label" textfield with "Preis" text is displayed
      And the "tariff_price.sublabel" textfield with "(inkl. MwSt.)" text is displayed
      And the "tariff_price.value" textfield with the "(\d+,\d\d €|Kostenlos)" format is displayed
      And the "renewal_period.label" textfield with "Laufzeit" text is displayed
      And the "renewal_period.sublabel" textfield with "(autom. Verlängerung)" text is displayed
      ...
      And the "details.description" textfield is displayed
  ...
  Scenario Outline: A prepay user can close "Selected Tariff" screen and go back to "<initial_page>" screen
    ...
    Examples:
          ...
          | Account      | Tariff Card   | tariff_card.change_tariff_button   | QANOV-195755 | QANOV-195758 |
          | My Tariff    | Tariff Header | tariff_header.change_tariff_button | QANOV-195756 | QANOV-195759 |

  @jira.QANOV-195764 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195757 @manual @mobile @o2de @smoke
  Scenario: A prepay user with bank account in "activated" status can access the "Tariff Payment Method" screen
    Given user has a "prepay" account type
     ...
     Then the "Tariff Payment Methods" page is displayed
      ...
      And the "tariff.name" textfield is displayed
      And the "tariff.label" textfield with "(inkl. MwSt.)" text is displayed
  ...
  @jira.QANOV-195766 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195757 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-195765 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195757 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-195767 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195765 @manual @mobile @o2de @regression
  ...
  @jira.<jira_id> @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195764 @jira.link.depends_on.QANOV-195765
  @manual @mobile @o2de @regression
  Scenario Outline: A prepay user can close the "Tariff Payment Method" page and go back to "<initial_page>" screen
    ...
    Examples:
          ...
          | Account      | tariff_card.change_tariff_button   | Tariff Card   | QANOV-195768 |
          | My Tariff    | tariff_header.change_tariff_button | Tariff Header | QANOV-195769 |

  @jira.QANOV-420502 @android @ber @ios @jira.cv.Future @jira.link.depends_on.QANOV-195764
  @manual @mobile @o2de @smoke
  ...
  @jira.QANOV-420504 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195764 @jira.link.depends_on.QANOV-195765
  @jira.link.depends_on.QANOV-195766 @manual @mobile @o2de @smoke
  ...
  @jira.QANOV-420505 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195764 @jira.link.depends_on.QANOV-195765
  @jira.link.depends_on.QANOV-195766 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-420506 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-420505 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-420507 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420504
  @manual @mobile @o2de @regression
  ...
  @jira.QANOV-420508 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420504
  @manual @mobile @o2de @regression
  ...
  @jira.QANOV-195763 @TBD @android @jira.cv.Future @jira.link.depends_on.QANOV-195770 @jira.link.depends_on.QANOV-195771
  @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420503 @jira.link.depends_on.QANOV-420504
  @manual @mobile @o2de @regression
  Scenario: A prepay user can access to the legal info link from the "Order confirmation" screen on Android devices
    Link: https://www.o2online.de/assets/blobs/pdfs/datenschutzmerkblatt-telefonica/
    Given user has a "prepay" account type
      And user has a changeable tariff
  ...
  @jira.QANOV-292096 @ios @jira.cv.Future @jira.link.depends_on.QANOV-195770 @jira.link.depends_on.QANOV-195771
  @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420503 @jira.link.depends_on.QANOV-420504
  @manual @mobile @o2de @regression
  Scenario: A prepay user can access to the legal info link from the "Order confirmation" screen on iOS devices
    Link: https://www.o2online.de/assets/blobs/pdfs/datenschutzmerkblatt-telefonica/
    Given user has a "prepay" account type
      And user has a changeable tariff
      And user has the "Tariff Order Confirmation" module configured in CMS for "Tariff Order Confirmation" page
  ...
  @jira.<jira_id> @TBD @android @jira.cv.Future @jira.link.depends_on.QANOV-195770 @jira.link.depends_on.QANOV-195771
  @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420503 @jira.link.depends_on.QANOV-420504
  @manual @mobile @o2de @regression
  Scenario Outline: A prepay user can access to the "<legal_document>" legal document from the "Tariff Order Confirmation" screen on Android devices
    ...
    Examples:
          ...
          | terms_and_conditions_link | Terms And Conditions | QANOV-195772 |
          | services_description_link | Services Description | QANOV-195773 |
          | price_list_link           | Price List           | QANOV-195774 |
          | right_of_withdrawal_link  | Right Of Withdrawal  | QANOV-195775 |

  @jira.<jira_id> @ios @jira.cv.Future @jira.link.depends_on.QANOV-195770 @jira.link.depends_on.QANOV-195771
  @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420503 @jira.link.depends_on.QANOV-420504
  @manual @mobile @o2de @regression
  Scenario Outline: A prepay user can access to the "<legal_document>" legal document from the "Tariff Order Confirmation" screen on iOS devices
    ...
    Examples:
          | link                      | legal_document       | jira_id      |
          | terms_and_conditions_link | Terms And Conditions | QANOV-292097 |
          | services_description_link | Services Description | QANOV-292098 |
          | price_list_link           | Price List           | QANOV-292099 |
          | right_of_withdrawal_link  | Right Of Withdrawal  | QANOV-292100 |

  @jira.QANOV-420509 @TBD @android @jira.cv.Future @jira.link.depends_on.QANOV-420507 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-420510 @ios @jira.cv.Future @jira.link.depends_on.QANOV-420507 @manual @mobile @o2de @regression
  ...
  @jira.<jira_id> @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195770 @jira.link.depends_on.QANOV-195771
  @jira.link.depends_on.QANOV-420502 @jira.link.depends_on.QANOV-420503 @jira.link.depends_on.QANOV-420504 @manual @mobile
  @o2de @regression
  Scenario Outline: A prepay user can close the "Tariff Order Confirmation" screen and go back to "<initial_page>" screen
    ...
    Examples:
          | initial_page | change_tariff_button               | module        | jira_id      |
          | Account      | tariff_card.change_tariff_button   | Tariff Card   | QANOV-195778 |
          | My Tariff    | tariff_header.change_tariff_button | Tariff Header | QANOV-195781 |

  @jira.QANOV-195776 @android @ber @ios @jira.cv.Future @jira.link.depends_on.QANOV-195770
  @jira.link.depends_on.QANOV-420502 @manual @mobile @o2de @smoke
  ...
  @jira.QANOV-195777 @android @ber @ios @jira.cv.Future @jira.link.depends_on.QANOV-195771
  @jira.link.depends_on.QANOV-420503 @jira.link.depends_on.QANOV-420504 @manual @mobile @o2de @smoke
  ...
  @jira.<jira_id> @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195776 @jira.link.depends_on.QANOV-195777
  @manual @mobile @o2de @regression
  Scenario Outline: A prepay user can close the "Change Tariff Success Feedback" screen an go back to "<initial_page>" screen
    ...
    Examples:
          | initial_page | change_tariff_button               | module        | jira_id      |
          | Account      | tariff_card.change_tariff_button   | Tariff Card   | QANOV-195778 |
          | My Tariff    | tariff_header.change_tariff_button | Tariff Header | QANOV-195779 |

  @jira.QANOV-195782 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195776 @jira.link.depends_on.QANOV-195777
  @manual @mobile @o2de @regression
  ...
  @jira.QANOV-195784 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195770 @manual @mobile @o2de @regression
  ...
  @jira.QANOV-195788 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195771 @jira.link.depends_on.QANOV-420503
  @jira.link.depends_on.QANOV-420504 @manual @mobile @o2de @regression
  Scenario: A prepay user with enough balance confirms the change tariff payment with balance but an error happens: purchase finished unsuccessfully
    Given user has a "prepay" account type
      And user has a changeable tariff
      And user has enough balance to purchase "any" tariff
      And user has the "Offered Tariffs List" module configured in CMS for "Available Tariffs" page
      And user has the "Tariff Payment Methods" module configured in CMS for "Tariff Payment Methods" page
      And user has the "Tariff Order Confirmation" module configured in CMS for "Tariff Order Confirmation" page
      And user has the "Change Tariff Error Feedback" module configured in CMS for "Change Tariff Error Feedback" page
  ...
  @jira.<jira_id> @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195784 @jira.link.depends_on.QANOV-195788
  @manual @mobile @o2de @regression
  Scenario Outline: A prepay user can close the "Change Tariff Error Feedback" screen and go back to "<initial_page>" screen
    ...
    Examples:
          | initial_page | change_tariff_button               | module        | jira_id      |
          | Account      | tariff_card.change_tariff_button   | Tariff Card   | QANOV-195785 |
          | My Tariff    | tariff_header.change_tariff_button | Tariff Header | QANOV-195786 |

  @jira.QANOV-195791 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195784 @jira.link.depends_on.QANOV-195788
  @manual @mobile @o2de @regression
  ...
  @jira.QANOV-195792 @android @ios @jira.cv.Future @jira.link.depends_on.QANOV-195766 @manual @mobile @o2de @smoke
  Scenario: A prepay user without registered bank account can activate bank account
    Given user has a "prepay" account type
      And user has a changeable tariff
      And user does not have bank account
      And user has the "Tariff Payment Methods" module configured in CMS for "Tariff Payment Methods" page
